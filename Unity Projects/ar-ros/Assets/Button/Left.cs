...
public class Left : MonoBehaviour
{
    ...
    public void OnClick()
    {
        ...
        {
            world1.transform.position += new Vector3(-0.05f, 0, 0);
        }
        else if (finishScript.cntClick == 1)
        {
            Cloud1.transform.localPosition += new Vector3(-0.05f, 0, 0);
        }
        else if (finishScript.cntClick == 2)
        {
            world2.transform.localPosition += new Vector3(-0.05f, 0, 0);
        }
        else if (finishScript.cntClick == 3)
        {
            Cloud2.transform.localPosition += new Vector3(-0.05f, 0, 0);
        }
        else if (finishScript.cntClick == 4)
        {
            Building.transform.localPosition += new Vector3(-0.05f, 0, 0);
        }
    }
}
