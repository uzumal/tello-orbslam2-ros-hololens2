...
public class PointCubeRenderer2 : MonoBehaviour
{
    public PointCloudSubscriber2 subscriber;
    public DownCloudSubscriber2 subscriber1;
    ...
    void Start()
    {
        pointCloud = GameObject.Find("PointCloud2");
